...
class qNetwork(keras.Model):
    ...
    def build(self):
        ...
        fc2 = Conv2D(64, (5, 5), strides=(2, 2), padding="same", activation='relu')(fc1)
        fc3 = Conv2D(64, (3, 3), strides=(2, 2), padding="same", activation='relu')(fc2)
...
class DDQNAgent:
    ...
    def __init__(self, alpha = None, gamma = None, epsilon = None, obs_shape = None,
        ...
        steering_actions = [-1.0, -0.75, -0.5, -0.25, 0.0, 0.25, 0.5, 0.75, 1.0]
        throttle_actions = [0.1]
